...
\</row\>  
\</dnslog\>  
> (Выделенный текст необходимо заменить соответствующими
...
1.  Вывести на экран в формате \"ДД-MM-ГГГГ ЧЧ:мм:СС.нс\" дату и время
...
(Выделенный текст необходимо заменить соответствующими значениями из логов.)  
...
1.  Домены второго уровня 1yf.de. и 2yf.de. являются DNS-туннелями. Они
